...
<body>
    ...
    <footer>
        <p>&copy; 2024 Green Apple Restaurant | Designed by: <b>RAMSANJAY C</b></p>
        <p>
...
<div class="menu-section">
    ...
    <div class="menu-grid">
        <div class="menu-item">
            <img src="chicken biriyani.jpeg" alt="Chicken Biriyani">
...
<div class="menu-section">
    ...
    <div class="menu-grid">
        ...
        <div class="menu-item">
            <img src="mutton 95.jpg" alt="Mutton 95">
            <h3>Mutton 95</h3>
...
<body>
    ...
    <div class="chefs-container">
        <div class="chef-card">
            <img src="chef dhamu.png" alt="Chef Dhamu">
        ...
        <div class="chef-card">
            <img src="che venky.jpg" alt="Chef Venkat">
            <div class="chef-details">
                <h1>Mr. Vennkat</h1>
        ...
        <div class="chef-card">
            <img src="Chef-Deena-Dayalan.jpg" alt="Chef Dheena">
            <div class="chef-details">
                <h1>Mr. Dheena</h1>
        ...
        <div class="chef-card">
            <img src="chef lady 1 1.jpg" alt="Chef Sunny">
            <div class="chef-details">
                <h1>Miss Sunny</h1>
        ...
        <div class="chef-card">
            <img src="chef lady 2.jpg" alt="Chef Ishuuu">
            <div class="chef-details">
                <h1>Miss Ishuuu</h1>
        ...
        <div class="chef-card">
            <img src="chef lady 3.jpg" alt="Chef Bujjimaa">
            <div class="chef-details">
                <h1>Ms. Bujjimaa</h1>
